const newMenuCategories = [
  ...
  },
  {
    ...
    subcategories: [
      ...
      {
        subcategoryName: "Inne do pielęgnacji urody",
        subcategoryOther: "not-allowed",
        codes: [
      ...
      },
      {
        ...
        subcategoryOther: "not-allowed",
        codes: [{ categoryCode: "101526", codeName: "Pozostałe" }],
      },
      {
        subcategoryName: "Akcesoria do ekspresów",
        subcategoryOther: "not-allowed",
        codes: [{ categoryCode: "101275", codeName: "Akcesoria do ekspresów" }],
      },
      {
        subcategoryName: "Pozostałe",
        subcategoryOther: "not-allowed",
        codes: [{ categoryCode: "100327", codeName: "Pozostałe" }],
      },
      {
        subcategoryName: "Dodatkowe wyposażenie",
        subcategoryOther: "not-allowed",
        codes: [{ categoryCode: "101474", codeName: "Dodatkowe wyposażenie" }],
      },
      {
        subcategoryName: "Przybory kuchenne",
        subcategoryOther: "not-allowed",
      ...
      {
        subcategoryName: "Środki czyszczące",
        subcategoryOther: "not-allowed",
        codes: [{ categoryCode: "101634", codeName: "Środki czyszczące" }],
      },
      {
        subcategoryName: "Środki czyszczące",
        subcategoryOther: "not-allowed",
        codes: [{ categoryCode: "101468", codeName: "Środki czyszczące" }],
      },
      {
        subcategoryName: "Środki czyszczące",
        subcategoryOther: "not-allowed",
        codes: [{ categoryCode: "101489", codeName: "Środki czyszczące" }],
      },
      {
        subcategoryName: "Akcesoria czyszczące",
        subcategoryOther: "not-allowed",
        codes: [{ categoryCode: "101487", codeName: "Akcesoria czyszczące" }],
      },
      {
        subcategoryName: "Akcesoria sportowe",
        subcategoryOther: "not-allowed",
        codes: [{ categoryCode: "101307", codeName: "Akcesoria sportowe" }],
      },
      {
        subcategoryName: "Środki czyszczące",
        subcategoryOther: "not-allowed",
        codes: [{ categoryCode: "101472", codeName: "Środki czyszczące" }],
      },
      {
        subcategoryName: "Środki piorące",
        subcategoryOther: "not-allowed",
        codes: [{ categoryCode: "101467", codeName: "Środki piorące" }],
      },
      {
        subcategoryName: "Akcesoria do mikrofalówek",
        subcategoryOther: "not-allowed",
        codes: [
      ...
      {
        subcategoryName: "Akcesoria do suszarek na pranie",
        subcategoryOther: "not-allowed",
        codes: [
          {
            categoryCode: "101635",
      ...
      {
        subcategoryName: "Akcesoria do maszynek do mielenia mięsa",
        subcategoryOther: "not-allowed",
        codes: [
          {
            categoryCode: "101523",
      ...
      {
        subcategoryName: "Akcesoria drobne RTV",
        subcategoryOther: "not-allowed",
        codes: [{ categoryCode: "100132", codeName: "Akcesoria drobne RTV" }],
      },
      {
        subcategoryName: "Dodatkowe wyposażenie do suszarek",
        subcategoryOther: "not-allowed",
        codes: [
          {
            categoryCode: "101470",
      ...
      {
        subcategoryName: "Akcesoria do robotów kuchennych",
        subcategoryOther: "not-allowed",
        codes: [
          {
            categoryCode: "101522",
      ...
      {
        subcategoryName: "Pochłaniacze i wkłady filtrujące",
        subcategoryOther: "not-allowed",
        codes: [{ codeName: "Pochłaniacze i wkłady filtrujące" }],
      },
      {
        subcategoryName: "Akcesoria do żelazek",
        subcategoryOther: "not-allowed",
        codes: [{ categoryCode: "101484", codeName: "Akcesoria do żelazek" }],
      },
      {
        subcategoryName: "Akcesoria do maszyn do szycia",
        subcategoryOther: "not-allowed",
        codes: [
      ...
      {
        subcategoryName: "Akcesoria montażowe",
        subcategoryOther: "not-allowed",
        codes: [{ categoryCode: "100784", codeName: "Akcesoria montażowe" }],
      },
      {
        subcategoryName: "Filtry do oczyszczaczy i nawilżaczy powietrza",
        subcategoryOther: "not-allowed",
        codes: [
          {
            categoryCode: "101525",
      ...
      {
        subcategoryName: "Sól do zmywarek",
        subcategoryOther: "not-allowed",
        codes: [{ categoryCode: "101477", codeName: "Sól do zmywarek" }],
      },
      {
...
export default newMenuCategories;
